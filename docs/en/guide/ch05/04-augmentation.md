...
[📖 **Complete Code Example**: `data_augmentation/`](../../../ch05-code-examples/) - Complete medical image augmentation implementation, 2D/3D transformations, and modality adaptation]
